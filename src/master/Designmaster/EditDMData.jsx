...
function EditDMData() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(e);
    await axios.put(`http://localhost:3003/DMdata/${id}`, designMasters);
    navigate("/dmaster");
  };

  const load = async () => {
    const result = await axios.get(`http://localhost:3003/DMdata/${id}`);
    //  console.log(result.data);
    setDesignMasters(result.data);
  };
